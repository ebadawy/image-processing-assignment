...
*
********************************************/
void read_image_array(char *file_name,
short **array)
{
int ok = 0;
...
*
*********************************************/
void create_resized_image_file(char *in_name, char *out_name,
...
*
***************************************************/
void create_allocate_tiff_file(char file_name[],
struct tiff_header_struct *image_header)
{
...
*
**********************************************/
int write_line(FILE *image_file, short **array,int line_number,
...
*
******************************************/
void read_bmp_file_header(char *file_name,
